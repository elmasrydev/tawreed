...
{{--
    Line icons in the Lucide/Feather style the design system uses: 24px grid,
    round caps and joins, currentColor stroke. Directional icons carry a
    `flip` flag so they mirror in right-to-left layouts.
--}}
@php
    $icons = [
        ...
        'flask' => '<path d="M9 3h6"/><path d="M10 3v6.5L4.5 19a1.5 1.5 0 0 0 1.3 2.25h12.4a1.5 1.5 0 0 0 1.3-2.25L14 9.5V3"/><path d="M7 15h10"/>',
    ...
    $directional = ['arrow-left', 'arrow-right', 'chevron-left', 'chevron-right', 'send', 'log-out'];
@endphp

<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="{{ $size }}" height="{{ $size }}"
     fill="none" stroke="currentColor" stroke-width="{{ $stroke }}" stroke-linecap="round" stroke-linejoin="round"
     aria-hidden="true" focusable="false"
     {{ $attributes->class(['shrink-0', 'rtl:-scale-x-100' => in_array($name, $directional, true)]) }}>{!! $icons[$name] ?? $icons['info'] !!}</svg>
